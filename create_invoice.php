<?php 
   ...
   ?>
<title>Systeme Facturation </title>
      ...
      <div class="load-animate animated fadeInUp">
         <div class="row">
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
               <h2 class="title">Gestion de factures</h2>
         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
               ...
               <div class="form-group">
                  <input type="text" class="form-control" name="companyName" id="companyName" placeholder="Votre nom d'entreprise" autocomplete="off">
               </div>
               <div class="form-group">
                  <textarea class="form-control" rows="3" name="address" id="address" placeholder="Saisir votre adresse ici..."></textarea>
               </div>
            </div>
         </div>
         <div class="row">
         ...
         <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
           ...
           <input value="" type="number" class="form-control" name="taxRate" id="taxRate" placeholder="Taux">
          </div>
              </div>
          </div>
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
          ...
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <input value="" type="number" class="form-control" name="amountPaid" id="amountPaid" placeholder="Saisir le montant payé">
          </div>
              </div>
          </div>
          <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
               ...
               <div class="form-group">
                  ...
                  <input data-loading-text="Saving Invoice..." type="submit" name="invoice_btn" value="Enrgistrer" class="btn btn-success submit_btn invoice-save-btm">           
               </div>
            </div>
         </div>

...
<div class="container content-invoice">
    	<div class="cards">
	    	...
	    	<div class="load-animate animated fadeInUp">
		    	<div class="row">
		    		<div class="col-xs-12">
		    			<h1 class="title">Systeme de Facturation</h1>
		    	...
		    	<div class="row">
		      		...
		      		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		      			...
		      			<div class="form-group">
							<input value="<?php echo $invoiceValues['order_receiver_name']; ?>" type="text" class="form-control" name="Nom d'entreprise" id="Nom d'entreprise" placeholder="Nom d'entreprise" autocomplete="off">
						</div>
						<div class="form-group">
							<textarea class="form-control" rows="3" name="adresse" id="adresse" placeholder="Votre adresse"><?php echo
		      		...
		      		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		      			<table class="table table-condensed table-striped" id="invoiceItem">	
							<tr>
								...
								<th width="15%">N° article</th>
								<th width="38%">Nom article</th>
		      	...
		      	<div class="row mt-3 mb-3">
		      		<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
		      			...
		      			<button class="btn btn-primary border-0" id="addRows" type="button">+ Ajouter</button>
		      		</div>
		      	</div>
		      	<div class="row">	
				 	    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group mt-3 mb-3">
								...
								<div class="input-group">
									...
									<input value="<?php echo $invoiceValues['order_total_before_tax']; ?>" type="number" class="form-control" name="subTotal" id="subTotal" placeholder="Sous total">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group-prepend">
									...
									<input value="<?php echo $invoiceValues['order_tax_per']; ?>" type="number" class="form-control" name="taxRate" id="taxRate" placeholder="Taux">
								</div>
							</div>
						</div>
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									...
									<input value="<?php echo $invoiceValues['order_total_tax']; ?>" type="number" class="form-control" name="taxAmount" id="taxAmount" placeholder="Montant de la TVA">
								</div>
							</div>	
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">						
							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-append currency"><span class="input-group-text">€</span></div>
									<input value="<?php echo $invoiceValues['order_amount_paid']; ?>" type="number" class="form-control" name="amountPaid" id="amountPaid" placeholder="Montant payé">
								</div>
							</div>
							</div>
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
							<div class="form-group">
								...
								<div class="input-group">
									<div class="input-group-append currency"><span class="input-group-text">€</span></div>
									<input value="<?php echo $invoiceValues['order_total_amount_due']; ?>" type="number" class="form-control" name="amountDue" id="amountDue" placeholder="Montant dû">
								</div>
							</div>
							</div>
